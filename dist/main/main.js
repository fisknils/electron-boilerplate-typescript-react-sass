...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "476cbb0cf60f9b350d3d";
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__dirname) {\nexports.__esModule = true;\nvar electron_1 = __webpack_require__(/*! electron */ \"electron\");\nvar path = __webpack_require__(/*! path */ \"path\");\nvar url_1 = __webpack_require__(/*! url */ \"url\");\n__webpack_require__(/*! ./ipcMain */ \"./src/main/ipcMain.ts\");\nvar isDevelopment = \"development\" !== \"production\";\n// global reference to mainWindow (necessary to prevent window from being garbage collected)\nvar mainWindow = [];\nfunction createMainWindow() {\n    var window = new electron_1.BrowserWindow({\n        webPreferences: { nodeIntegration: true },\n    });\n    if (isDevelopment) {\n        window.webContents.openDevTools();\n    }\n    if (isDevelopment) {\n        window.loadURL(\"http://localhost:\" + process.env.ELECTRON_WEBPACK_WDS_PORT);\n    }\n    else {\n        window.loadURL(url_1.format({\n            pathname: path.join(__dirname, \"..\", \".renderer-index-template.html\"),\n            protocol: \"file\",\n            slashes: true,\n        }));\n    }\n    window.on(\"closed\", function () {\n        mainWindow = [];\n    });\n    window.webContents.on(\"devtools-opened\", function () {\n        window.focus();\n        setImmediate(function () {\n            window.focus();\n        });\n    });\n    return window;\n}\n// quit application when all windows are closed\nelectron_1.app.on(\"window-all-closed\", function () {\n    // on macOS it is common for applications to stay open until the user explicitly quits\n    if (process.platform !== \"darwin\") {\n        electron_1.app.quit();\n    }\n});\nelectron_1.app.on(\"activate\", function () {\n    // on macOS it is common to re-create a window even after all windows have been closed\n    if (!mainWindow.length) {\n        mainWindow.push(createMainWindow());\n    }\n});\n// create main BrowserWindow when electron is ready\nelectron_1.app.on(\"ready\", function () {\n    mainWindow.push(createMainWindow());\n});\n\n/* WEBPACK VAR INJECTION */}.call(this, \"src/main\"))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/main/index.ts\n");
...
"use strict";
eval("\nexports.__esModule = true;\nvar electron_1 = __webpack_require__(/*! electron */ \"electron\");\nelectron_1.ipcMain.on(\"version\", function (event) {\n    event.returnValue = process.version;\n});\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/main/ipcMain.ts\n");
...
__webpack_require__(/*! /Users/andersmagnusson/Projects/node-projects/GUI/boilerplates/electron-react-typescript/node_modules/electron-webpack/out/electron-main-hmr/main-hmr */"./node_modules/electron-webpack/out/electron-main-hmr/main-hmr.js");
module.exports = __webpack_require__(/*! /Users/andersmagnusson/Projects/node-projects/GUI/boilerplates/electron-react-typescript/src/main/index.ts */"./src/main/index.ts");
